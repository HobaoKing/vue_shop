 ...
 * @LastEditTime: 2020-12-28 10:59:40
...
<template>
  <el-container class="home-container">
    ...
    <el-header>
      <div>
        <img
          src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=242773409,2956311969&fm=15&gp=0.jpg"
          width="50px"
          height="50px"
        />
        <span>电商管理系统</span>
        ...
        >
          ...
          >
            ...
            <el-menu-item
              ...
              :key="menuItem.id"
              :index="'/' + menuItem.path"
              @click="saveMenuItemClick('/' + menuItem.path)"
            >
              <template slot="title">
                <!-- 图标 -->
...
export default {
  ...
  created() {
    this.getMenuList()
    this.activeDefault = window.sessionStorage.getItem('activeDefault')
  },
  methods: {
    // 退出登录
    logoutClick() {
    ...
    saveMenuItemClick(menuItemPath) {
      window.sessionStorage.setItem('activeDefault', menuItemPath)
      this.activeDefault = menuItemPath
    },
  },
}
</script>
